...
(function (root, $, undefined) {
  ...
  Plugin.prototype = {
    init: function () {
      ...
      this.initialValue =
        this.getValue() || this.options.initialValue || this.min;
    ...
    disableButton: function ($button) {
      $button
        .addClass(this.options["classNameDisabled"])
        .attr("disabled", true);
      return this;
    },
    ...
    enableButton: function ($button) {
      $button
        .removeClass(this.options["classNameDisabled"])
        .attr("disabled", false);
      return this;
    },
